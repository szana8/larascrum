                ...
                <div class="text-blue">
                    ...
                    <form class="mt-12" method="POST" @submit.prevent="submit">
                        <div class="bg-grey-lighter border-b border-grey mb-6 flex">
                            ...
                            <input class="w-full bg-grey-lighter py-5 px-4 text-grey-darker border border-grey-lighter leading-tight focus:outline-none active:bg-grey-lighter" type="text" v-bind:class="{ 'border-red' : errors.email }" placeholder="Email Address" v-model="email">
                        ...
                        <div class="bg-grey-lighter border-b border-grey mb-6 flex">
                            ...
                            <input class="appearance-none block w-full bg-grey-lighter py-5 px-4 outline:none text-grey-darker leading-tight focus:outline-none active:bg-grey-lighter" type="password" placeholder="Password" v-bind:class="{ 'border-red' : errors.password }" v-model="password">
