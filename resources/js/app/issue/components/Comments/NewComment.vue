        ...
        <slide-y-down-transition :duration="500">
            <div class="w-1/2 z-50 fixed pin-b pin-x mx-auto flex-col flex bg-white border-t-2 border-r-2 border-l-2 border-blue p-6 shadow-md rounded-t" v-show="isActive">
                ...
                <div class="py-2 border-b border-grey-light">
                    <textarea class="w-full h-32 focus:outline-none text-grey-darkest resize-none" placeholder="But here's the thing..." v-model="reply"></textarea>
                </div>
                <div class="text-grey-darker py-4 flex justify-between">
                    ...
                    <div class="flex">
                        ...
                        <button class="bg-blue text-grey-lightest border border-blue rounded-full px-4 py-2 text-sm hover:bg-blue-dark hover:border-blue-dark uppercase mx-2 font-semibold focus:outline-none">Post</button>
                    </div>
                </div>
            </div>
