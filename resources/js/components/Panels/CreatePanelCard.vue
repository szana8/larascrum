<template>
    <div class="text-center">
        ...
        <div class="flex justify-end" v-if="isSelected == name">
            <div class="bg-blue-dark rounded-full w-12 h-12 absolute -mt-8 ml-6 shadow-md text-white">
        ...
        <div class="text-blue-dark font-semibold my-4 uppercase text-sm" :class="isActiveType(name)" v-text="name" />
    </div>
</template>
